...
(cl:defmethod cl:initialize-instance :after ((m <Size>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Size)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_vision-msg:<Size> is deprecated: use robot_vision-msg:Size instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Size>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_vision-msg:width-val is deprecated.  Use robot_vision-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'high-val :lambda-list '(m))
(cl:defmethod high-val ((m <Size>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_vision-msg:high-val is deprecated.  Use robot_vision-msg:high instead.")
  (high m))
