...
(cl:defmethod cl:initialize-instance :after ((m <Size>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Size)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vision1-msg:<Size> is deprecated: use vision1-msg:Size instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Size>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision1-msg:width-val is deprecated.  Use vision1-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'high-val :lambda-list '(m))
(cl:defmethod high-val ((m <Size>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision1-msg:high-val is deprecated.  Use vision1-msg:high instead.")
  (high m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Size>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision1-msg:x-val is deprecated.  Use vision1-msg:x instead.")
  (x m))
